...
const debug = require("debug")("PeerTracker:Server"), redis = require("redis"), GeoIpNativeLite = require("geoip-native-lite"), bencode = require("bencode"), cors = require("cors");
// Load in GeoData
...
class Server {
    constructor(opts) {
        ...
        self.app = express();
        self.app.use(cors());
        self.expressWs = require("express-ws")(self.app);
...
//# sourceMappingURL=/Users/connor/Desktop/Programming/myModules/peer-tracker/ts-node/b80e7f10257a0a2b7f29aee28a53e164f19fc5f2/4b222f88e7515a876bf6e92cbcb325dca4c08a6c.js.map