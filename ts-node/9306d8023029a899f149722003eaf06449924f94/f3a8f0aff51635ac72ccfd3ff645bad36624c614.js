...
class Server {
    ...
    |__| |__|         UDP PORT:       ${self.udpPORT}
    |  | |  |         HTTP & WS PORT: ${self.PORT}
   |   | |   |
   |   | |   |
  |    | |    |       LET'S BUILD AN EMPIRE!
  |____| |____|          https://github.com/CraigglesO/peer-tracker
      `);
        // Redis
        if (opts.docker)
        ...
        self.server.listen(self.PORT, function () { console.log("HTTP Server Ready" + ",\nWebsockets Ready."); });
        // WebSocket:
        ...
        self.udp4.on("listening", () => { console.log("UDP-4 Bound and ready."); });
...
//# sourceMappingURL=/Users/connor/Desktop/2017/PeerTracker/node/ts-node/9306d8023029a899f149722003eaf06449924f94/f3a8f0aff51635ac72ccfd3ff645bad36624c614.js.map