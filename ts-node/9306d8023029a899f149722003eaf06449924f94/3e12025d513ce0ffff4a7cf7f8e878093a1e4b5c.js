...
class Client extends events_1.EventEmitter {
    constructor(type, announcement, trackerHost, port, myPort, infoHash, left, uploaded, downloaded) {
        ...
        if (self.TYPE === "udp") {
            ...
            self.server.on('message', function (msg, flags) {
                console.log('message!');
                console.log(msg);
    ...
    sendPacket(buf) {
        ...
        if (self.TYPE === "udp") {
            ...
            console.log('sending buffer back');
...
//# sourceMappingURL=/Users/connor/Desktop/2017/PeerTracker/node/ts-node/9306d8023029a899f149722003eaf06449924f94/3e12025d513ce0ffff4a7cf7f8e878093a1e4b5c.js.map