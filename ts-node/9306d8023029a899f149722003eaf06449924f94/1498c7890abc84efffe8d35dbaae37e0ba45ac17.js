  ...
  |____| |____|
      `);
        ...
        self.wss.on("connection", function connection(ws) {
            ...
            let ip = ws.upgradeReq.headers['x-forwarded-for'];
            console.log("ws.upgradeReq", ws.upgradeReq);
            // let peerAddress = ip.split(":")[0];
            // let port        = ip.split(":")[1];
            console.log("ip:", ip);
...
//# sourceMappingURL=/Users/connor/Desktop/2017/PeerTracker/node/ts-node/9306d8023029a899f149722003eaf06449924f94/1498c7890abc84efffe8d35dbaae37e0ba45ac17.js.map