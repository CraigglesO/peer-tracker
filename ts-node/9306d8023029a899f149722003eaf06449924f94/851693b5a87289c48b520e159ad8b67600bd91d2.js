    ...
    switch (action) {
        ...
        case ACTION_SCRAPE:
            ...
            for (let i = 16; i < (buf.length - 16); i += 20) {
                console.log('REQUEST LOOP CALLED');
                ...
                client.mget([hash + ":seeders", hash + ":leechers", hash + ":completed"], (err, rply) => {
                    ...
                    if ((i + 16) >= (buf.length - 16)) {
                        ...
                        console.log('SCRAPES', scrapes.toString('hex'));
                        responces = buffer_1.Buffer.concat([responces, scrapes]);
                        console.log('RESPONCES', responces.toString('hex'));
                        cb(responces);
                    }
                });
            }
...
//# sourceMappingURL=/Users/connor/Desktop/2017/PeerTracker/node/ts-node/9306d8023029a899f149722003eaf06449924f94/851693b5a87289c48b520e159ad8b67600bd91d2.js.map